...
class Consultica_Admin_Info
{
    ...
    {
        add_theme_page(
            esc_html__('Consultica Theme', 'consultica'),
            esc_html__('Consultica Theme', 'consultica'),
            'edit_theme_options',
            'consultica',
    ...
    public function check_rt_easy_builder_freemius()
    {
        if (function_exists('RT_Easy_Builder\rt_freemius') && ! RT_Easy_Builder\rt_freemius()->is_not_paying()) {
            ...
            add_action('wp_ajax_dismiss_Consultica_notification', array($this, 'dismiss_notification_ajax_handler'));
        }
    }
    ...
    {
        delete_transient('consultica_notification_dismissed');
    }
    ...
    public function compatible_check()
    {
        ...
        $dismissed = get_option('consultica_notification_dismissed');
        if (!$dismissed) {
    ...
    public function dismiss_notification()
    {
        ...
        update_option('consultica_notification_dismissed', true);
    }
            ...
            (function($) {
                $(document).on('click', '.notice.is-dismissible .notice-dismiss', function() {
                    $.ajax({
                        ...
                        type: 'POST',
                        data: {
                            action: 'dismiss_consultica_notification',
...
// Instantiate the Consultica Admin Info class
new Consultica_Admin_Info();
