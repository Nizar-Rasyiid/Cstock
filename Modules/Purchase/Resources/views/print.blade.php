...
<head>
    ...
    <link rel="stylesheet" href="/b3/bootstrap.min.css">
</head>
<body>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div style="text-align: center;margin-bottom: 25px;">
                @if ($kop != null)
                    <img width="180" src="{{ asset('storage/'.$kop->company_logo) }}" alt="Logo">
                @else
                    <img width="180" src="/images/logo-dark.png" alt="Logo">
                @endif
                ...
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-xs-4 mb-3 mb-md-0">
                            ...
                            @if ($kop != null)
                                <div><strong>{{ $kop->company_name }}</strong></div>
                                <div>{{ $kop->company_address }}</div>
                                <div>Email: {{ $kop->company_email }}</div>
                                <div>Phone: {{ $kop->company_phone }}</div>
                            @else
                            ...
                            @foreach($purchase->purchaseDetails as $item)
                                <tr>
                                    <td class="align-middle">
                                        ...
                                        <br>
                                        {!! nl2br(@$item->product->product_note) !!}
                                        <br>
                                    ...
                                    <td>
                                        @forelse($item->product->getMedia('images') as $media)
                                            <img src="{{ $media->getUrl() }}" alt="Product Image" height="100px" width="auto">
                                        @empty
                                            <img src="{{ $item->product->getFirstMediaUrl('images') }}" alt="Product Image" height="100px" width="auto">
                                        @endforelse
                                    </td>
